...
def test(opt):
    ...
    # BaseDetector.pre_process 
    # index, kpts_2d_pred, widths_pred, img, depth_raw 
    ...
    results = {}
    # return self.num_samples = scenes * 5
    ...
    for ind, (img_id, oracle_dets_or_pre_processed_images) in enumerate(data_loader):
        ...
        # apply KGN   input = image
        quaternions, locations, widths, kpts_2d_pred, scores, output = kgn.generate(oracle_dets_or_pre_processed_images)
