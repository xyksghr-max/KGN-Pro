...
import sys
sys.path.append('../EPro-PnP-6DoF_v2/lib/utils')
import argparse
...
class config():
    def __init__(self):
        ...
        #self.parser.add_argument('--cfg', required=True, type=str, help='../EPro-PnP-6DoF-v2/tools/exps_cfg/epropnp_v2_cdpn_init.yaml')
    ...
    def parse(self):
        ...
        args = argparse.Namespace(cfg='../EPro-PnP-6DoF_v2/tools/exps_cfg/epropnp_v2_cdpn_init.yaml')
